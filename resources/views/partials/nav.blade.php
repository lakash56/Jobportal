        ...
        <div class="site-navbar bg-light">
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                <h2 class="mb-0 site-logo"><a href="{{ url('/') }}"><strong class="font-weight-bold">JobsForYou</strong> </a></h2>
              </div>
              <div class="col-10">
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    @endif
                      ...
                      <li><a href="{{route('list.all.company')}}">Company</a></li>
                      <li><a href="contact.html">Contact</a></li>
                        <li>
                            @if(!Auth::check())
                            <button type="button" class="btn btn-primary -white py-3 px-4 rounded" data-toggle="modal" data-target="#exampleModal">
                                <span>LogIn</span>
                              </button>
                              @else
